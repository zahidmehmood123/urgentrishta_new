    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-12 text-center">
                <h2 class="heading heading-3 strong-400 mb-0">Member Interests</h2>
            </div>
        </div>
    </div>
</section>
                        ...
                        <div class="row">
                            <form id="controls-form" action="javascript:void();">
                                ...
                                <div class="col col-sm-12 col-md-12">
                                    <span><label for="pagesize">Number of entries: <select name="pagesize" class="custom-select custom-select-sm form-control form-control-sm" onchange="javascript:refreshInterests(true);">
                                        <option value="10">10</option>
                                        <option value="25">25</option>
                                        <option value="50">50</option>
                                        <option value="100">100</option>
                                    </select></label></span>
                                    <span><label for="term">Search: <input type="search" name="term" class="form-control form-control-sm" placeholder="Enter search query..." autocomplete="off" onkeyup="javascript:refreshInterests(true);" value="" /></label></span>
