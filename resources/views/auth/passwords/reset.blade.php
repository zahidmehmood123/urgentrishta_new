            ...
            <div class="col-lg-4 col-md-6 ml-auto mr-auto">
                <div class="form-card form-card--style-2 z-depth-3-top">
                    <div class="form-body">
                        ...
                        <form class="form-default" id="reset_password_form" role="form" method="post" action="{{ route('password.update') }}">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-12 text-center">
                                    <button type="submit" id="btnSubmit" class="btn btn-styled btn-sm btn-block btn-base-1 z-depth-2-bottom mt-4">RESET PASSWORD</button>
                                </div>
                            </div>
                        </form>
                    </div>
